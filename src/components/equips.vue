...
export default {
  ...
  methods: {
    ...
    handleUpdateSubmit() {
      ...
      this.$http.post("/api/equips/update", this.updateForm).then(res => {
        var data = res.data;
        if (data.code == 200) {
          this.$Message.success({
            content: data.msg,
            ...
            onClose: () => {
              ...
              tableData[index].equip_name = updateForm.equip_name;
              tableData[index].brand = updateForm.brand;
              tableData[index].type = updateForm.type;
              tableData[index].count = updateForm.count;
              tableData[index].remark = updateForm.remark;
