<template>
  <div>
    <Layout>
      <!--<Header class="head">-->
        <!--<Form ref="showInfo" :model="showInfo" :label-width="80" style="float:left;margin-top:6px">-->
          <!--<FormItem label="演出名称" prop="showId">-->
            <!--<Input v-model="showInfo.showId"></Input>-->
          <!--</FormItem>-->
        <!--</Form>-->
        <!--<router-link to="/main/equips-check/output">出库装备</router-link>-->
        <!--<router-link to="/main/equips-check/putaway">入库装备</router-link>-->
      <!--</Header>-->
